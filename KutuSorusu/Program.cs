...
Console.WriteLine($"{"1.".Pastel(Color.Coral)} Soru İçin En Uygun Kullanilan Alan:{sonuc.ToString().Pastel(Color.FromArgb(255, 0, 0)).PastelBg("#34eb49")} \n");
...
Console.WriteLine($"{"2.".Pastel(Color.Aquamarine)} Soru İçin En Uygun Kullanilan Alan:{sonuc.ToString().Pastel(Color.FromArgb(255, 0, 0)).PastelBg("#34eb49")} \n");
...
Console.WriteLine($"{"3.".Pastel(Color.MediumPurple)} Soru İçin En Uygun Kullanilan Alan:{sonuc.ToString().Pastel(Color.FromArgb(255, 0, 0)).PastelBg("#34eb49")} \n");
...
Console.WriteLine($"{"4.".Pastel(Color.PeachPuff)} Soru İçin En Uygun Kullanilan Alan:{sonuc.ToString().Pastel(Color.FromArgb(255, 0, 0)).PastelBg("#34eb49")} \n");
...
Console.WriteLine($"{"5.".Pastel(Color.Plum)} Soru İçin En Uygun Kullanilan Alan:{sonuc.ToString().Pastel(Color.FromArgb(255, 0, 0)).PastelBg("#34eb49")} \n");
